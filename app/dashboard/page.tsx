...
`
  ...
  const quizHistory = [
    { subject: "JavaScript Basics", participants: 45, numbers: 13 },
    { subject: "React Hooks", participants: 32, numbers: 20 },
    { subject: "TypeScript Advanced", participants: 28, numbers: 9 },
  ];
